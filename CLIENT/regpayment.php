                    ...
                    <div style="padding: 6px 12px; border: 1px solid #ccc;height:auto; verflow: auto;">
                        ...
                        <?php include('errors.php'); ?>
                            ...
                            <?php
                                ...
                                $sql = "SELECT * FROM accountpayment WHERE username='$user'";
                                $result = mysqli_query($conn, $sql);
                                echo'<div class="form-group">';
                                while($row = mysqli_fetch_array($result, MYSQLI_NUM))
                                {	
                                  echo '<br><input type="text" value="'.$row[5].'" class="form-group" disabled="disabled">'; 
								}
								echo '</div>';
                            ?>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="amount"  min="0" max="9999999" maxlength="6" >
						    </div>
