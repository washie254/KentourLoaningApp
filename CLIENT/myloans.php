						...
						<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
							<ul id="myTab" class=" nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
									<span><img src="images/cashloan.png" style="width:80px; height:80px;"/></span>
									<h5>loan applications</h5>
									 loan applications Made <?php //echo $status;	?>
								</a></li>
							</ul>
							<!-- <ul> -->
								...
								<?php
									...
									$sql = "SELECT * FROM cashloans WHERE membername='$user'";
											...
											echo '<tr style="">';
												echo'<td style="width: 90px;font-size: 15px;">';
													...
													<td style="color:#9901C7; font-size: 15px;  ">
														<label>'.$row[0].'</label><br>
														<label>'.$row[1].'</label><br>
														<label>'.$row[2].'</label><br>
														<label>'.$row[8].'</label><br>
													</td>';
											echo '</tr>';
										echo '</table>';
										echo '</div>';
							...
							<div class="form-group">
                            	<button type="submit"  class="btn btn-success"><a href="payloans.php">PAY LOANS	</a></button>
						    </div>
							<p> PRIOR PAYMENTS </p>
							...
							<table class="table table-striped " >
								...
								<?php
									$sql = "SELECT * FROM cashloanpayments WHERE username='$user'";
									$result = mysqli_query($conn, $sql);
									while($row = mysqli_fetch_array($result, MYSQLI_NUM)){
										echo '<tr style="">';
											echo '<td>'.$row[3].'</td>';
