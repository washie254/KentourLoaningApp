	...
	<div class="agile-main"> 
		...
		<div class="content-wrap">
			...
			<div class="content">
				...
				<!-- welcome -->
				<div class="welcome"> 
					<h3 class="w3ls-title">ABOUT KENTOUR !</h3> 
					<p class="w3title-text">We deal with land buying and selling and now are offering loans for our company members </p>
					<div class="welcome-info">
						<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
							<ul id="myTab" class=" nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
									<span class="glyphicon glyphicon-briefcase"></span>
									<h5>Land</h5>
								</a></li>
								<li role="presentation"><a href="" role="tab" id="carl-tab" data-toggle="tab" aria-controls="carl"> 
									<span class="glyphicon glyphicon-signal"></span>
									<h5>Loans</h5>
								</a></li>
								<li role="presentation"><a href="" role="tab" id="james-tab" data-toggle="tab" aria-controls="james"> 
