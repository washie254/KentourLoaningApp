						...
						<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
							...
							<!-- <ul> -->
								...
								<?php
									...
									$sql0 = "SELECT * FROM accountpayment WHERE username='$user'";
											...
											echo '<tr style="">';
												echo'<td style="width: 90px;font-size: 15px;">';
													...
													<td style="color:#9901C7; font-size: 15px;  ">
														...
														<label>'.$row[5].'<b> || '.$row[6].' </b></label><br>
														<label>'.$row[7].'<b> || '.$row[8].' </b></label><br>
														<label>'.$bal.'</label><br>
													</td>';
											echo '</tr>';
										echo '</table>';
							...
							<?php 
									if($status=='REJECTED'){ 
										...
										$sql2 =" SELECT * FROM rejectedaccounts WHERE username='$userp'";
										...
										?>
											...
											<div style="padding: 6px 12px; border: 1px solid #ccc; border-radius: 10px; width:100%;" id="rejected">
