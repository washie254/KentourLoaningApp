						...
						<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
							<ul id="myTab" class=" nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
									<span><img src="images/land.png" style="width:80px; height:80px;"/></span>
									<h5>land Aplications</h5>
									land applications Made <?php //echo $status;	?>
								</a></li>
							</ul>
							<!-- <ul> -->
								...
								<?php
									...
									$sql = "SELECT * FROM landapplications WHERE memberid='$user'";
									...
									{	
										...
										<table class="container">
											...
											echo '<tr style="">';
												echo'<td style="width: 90px;font-size: 15px;">';
													echo '<b>
														<label>LAND TITLE</label><br>
														<label>STATUS </label><br>
														<label>Date App </label><br>
													</b></td>';
													echo '
													<td style="color:#9901C7; font-size: 15px;  ">
														<label>'.$row[2].'</label><br>
														<label>'.$row[6].'</label><br>
							...
							<div class="form-group">
                            	<button type="submit"  class="btn btn-success"><a href="paylands.php">PAY LANDS	</a></button>
						    </div>
							<p> PRIOR PAYMENTS </p>
							...
							<table class="table table-striped " >
								...
								<?php
									$sql = "SELECT * FROM landpayments WHERE username='$user'";
									$result = mysqli_query($conn, $sql);
									while($row = mysqli_fetch_array($result, MYSQLI_NUM)){
										echo '<tr style="">';
											echo '<td>'.$row[3].'</td>';
